...
<html lang="en">
  <head>
    ...
    <title>Internify | Employer</title>
  </head>
  <body style="background-color: #dcdcdc;font-family: 'Montserrat', sans-serif;s">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="min-height: 100px">
        <a class="navbar-brand" href="employerhome.php">Internify</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="employerhome.php">Dashboard</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="employerviewinternship.php">Internships</a>
            </li>
            <li class="nav-item">
